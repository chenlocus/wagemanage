================================================================================
    MICROSOFT 基础类库： wagemanage 项目概述
===============================================================================

应用程序向导已为您创建了此 wagemanage 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 wagemanage 应用程序的每个文件的内容摘要。
...
wagemanage.h
    ...
    CwagemanageApp 应用程序类。

wagemanage.cpp
    这是包含应用程序
    类 CwagemanageApp 的主应用程序源文件。
...
res\Toolbar.bmp
    ...
    更新 wagemanage.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

wagemanageDoc.h、wagemanageDoc.cpp - 文档
    这些文件包含 CwagemanageDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CwagemanageDoc::Serialize）。
wagemanageView.h、wagemanageView.cpp - 文档视图
    这些文件包含 CwagemanageView 类。
    CwagemanageView 对象用于查看 CwagemanageDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 wagemanage.pch 的预编译头文件 (PCH)
